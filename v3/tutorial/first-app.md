...
`composer.phar` в этом каталоге я собираюсь включить его также в свое репо; чтобы вы могли использовать `composer` 
команды на всех системах в которых надо.
...
PHP для обмена сообщениями HTTP, поэтому вы заметите, что при создании своего приложения вы часто видите 
